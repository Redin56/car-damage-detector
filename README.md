...
📓 [View notebook](https://nbviewer.org/github/Redin56/car-damage-detector/blob/main/car_damage_detector.ipynb) (GitHub's inline preview struggles with this file due to embedded output images — use the nbviewer link above for a clean render)
